...
public class JuicyLootWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(JuicyLootWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/JuicyLootWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/JuicyLootWLAIW/InitOutcome.xml").getDocumentElement();
